...
(cl:defmethod cl:initialize-instance :after ((m <Mavlink>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mavlink)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mavlink-msg:<Mavlink> is deprecated: use ros_mavlink-msg:Mavlink instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:header-val is deprecated.  Use ros_mavlink-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'checksum-val :lambda-list '(m))
(cl:defmethod checksum-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:checksum-val is deprecated.  Use ros_mavlink-msg:checksum instead.")
  (checksum m))

(cl:ensure-generic-function 'magic-val :lambda-list '(m))
(cl:defmethod magic-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:magic-val is deprecated.  Use ros_mavlink-msg:magic instead.")
  (magic m))

(cl:ensure-generic-function 'len-val :lambda-list '(m))
(cl:defmethod len-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:len-val is deprecated.  Use ros_mavlink-msg:len instead.")
  (len m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:seq-val is deprecated.  Use ros_mavlink-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'sysid-val :lambda-list '(m))
(cl:defmethod sysid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:sysid-val is deprecated.  Use ros_mavlink-msg:sysid instead.")
  (sysid m))

(cl:ensure-generic-function 'compid-val :lambda-list '(m))
(cl:defmethod compid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:compid-val is deprecated.  Use ros_mavlink-msg:compid instead.")
  (compid m))

(cl:ensure-generic-function 'msgid-val :lambda-list '(m))
(cl:defmethod msgid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:msgid-val is deprecated.  Use ros_mavlink-msg:msgid instead.")
  (msgid m))

(cl:ensure-generic-function 'fromlcm-val :lambda-list '(m))
(cl:defmethod fromlcm-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:fromlcm-val is deprecated.  Use ros_mavlink-msg:fromlcm instead.")
  (fromlcm m))

(cl:ensure-generic-function 'payload64-val :lambda-list '(m))
(cl:defmethod payload64-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mavlink-msg:payload64-val is deprecated.  Use ros_mavlink-msg:payload64 instead.")
  (payload64 m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Mavlink>)))
  ...
  "2508b91c8dc673f9656b8173afa17d4b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Mavlink)))
  "Returns md5sum for a message object of type 'Mavlink"
  "2508b91c8dc673f9656b8173afa17d4b")
