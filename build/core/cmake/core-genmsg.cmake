...
message(STATUS "core: 1 messages, 0 services")

set(MSG_I_FLAGS "-Icore:/home/pushyamikaveti/AeroTracker/src/core/msg;-Istd_msgs:/opt/ros/hydro/share/std_msgs/cmake/../msg")
...
_generate_msg_cpp(core
  "/home/pushyamikaveti/AeroTracker/src/core/msg/Camera_msgs.msg"
  "${MSG_I_FLAGS}"
  ""
...
debug_message(2 "core: Iflags=${MSG_I_FLAGS}")
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/core)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/core\")")
  # install generated code
  install(
